...
class WorkloadGenerator:
    ...
    def _generate_redis_store(self, adapter: str) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="store", adapter=adapter, data=data)
    ...
    def _generate_qdrant_store(self) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="store", adapter="qdrant", data=data)
    ...
    def _generate_neo4j_entity(self) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="store", adapter="neo4j", data=data)
    ...
    def _generate_typesense_store(self) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="store", adapter="typesense", data=data)
    ...
    def _generate_retrieve_op(self, adapter: str) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="retrieve", adapter=adapter, item_id=item_id)
    ...
    def _generate_redis_search(self, adapter: str) -> WorkloadOperation:
        ...
        query = {"session_id": random.choice(self.session_ids), "limit": random.choice([5, 10, 20])}

        return WorkloadOperation(op_type="search", adapter=adapter, query=query)
    ...
    def _generate_qdrant_search(self) -> WorkloadOperation:
        ...
        query = {
            ...
            "filter": {"session_id": random.choice(self.session_ids)}
            if random.random() < 0.5
            else None,
        }

        return WorkloadOperation(op_type="search", adapter="qdrant", query=query)
    ...
    def _generate_neo4j_search(self) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="search", adapter="neo4j", query=query)
    ...
    def _generate_typesense_search(self) -> WorkloadOperation:
        ...
        query = {
            ...
            "filter_by": f"session_id:={random.choice(self.session_ids)}"
            if random.random() < 0.5
            else None,
            "per_page": random.choice([5, 10, 20]),
        }

        return WorkloadOperation(op_type="search", adapter="typesense", query=query)
    ...
    def _generate_delete_op(self, adapter: str) -> WorkloadOperation:
        ...
        return WorkloadOperation(op_type="delete", adapter=adapter, item_id=item_id)
