...
class BenchmarkAnalyzer:
    ...
    def generate_all_tables(self, output_dir: Path | None = None) -> None:
        ...
        summary_file = (
            output_dir.parent.parent / "results" / "processed" / f"summary_{timestamp}.json"
        )
    ...
    def generate_summary(self) -> dict[str, Any]:
        ...
        Returns:
            Summary dictionary
        """
        summary = {"benchmark_info": self.results["benchmark_config"], "adapters": {}}
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Analyze benchmark results and generate tables")
    parser.add_argument(
        "--results", type=str, help="Path to benchmark results JSON file (default: most recent)"
    )
    parser.add_argument(
        "--output",
        type=str,
