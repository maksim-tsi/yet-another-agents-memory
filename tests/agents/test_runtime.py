...
class TestMASToolRuntime:
    ...
    def test_initialization(self):
        ...
        mock_runtime = MockToolRuntime(
            context=MASContext(session_id="test-123"), state={"messages": []}
        )
    ...
    def test_get_config_flag(self):
        ...
        context = MASContext(session_id="s1", enable_l1_cache=False, default_min_ciar=0.8)
        mock_runtime = MockToolRuntime(context=context, state={})
    ...
    def test_get_state_value(self):
        ...
        mock_runtime = MockToolRuntime(context=MASContext(session_id="s1"), state=state)
    ...
    def test_get_messages_returns_empty_list_if_missing(self):
        ...
        mock_runtime = MockToolRuntime(context=MASContext(session_id="s1"), state={})
    ...
    async def test_get_from_store(self):
        ...
        mock_runtime = MockToolRuntime(
            context=MASContext(session_id="s1"), state={}, store=mock_store
        )
    ...
    async def test_get_from_store_returns_none_if_no_store(self):
        ...
        mock_runtime = MockToolRuntime(context=MASContext(session_id="s1"), state={}, store=None)
    ...
    async def test_stream_update(self):
        ...
        mock_runtime = MockToolRuntime(
            context=MASContext(session_id="s1"), state={}, stream_writer=mock_writer
        )
    ...
    def test_get_tool_call_id(self):
        ...
        mock_runtime = MockToolRuntime(
            context=MASContext(session_id="s1"), state={}, tool_call_id="call-123"
        )
    ...
    def test_get_config(self):
        ...
        mock_config = Mock()
        mock_runtime = MockToolRuntime(
            context=MASContext(session_id="s1"), state={}, config=mock_config
        )
